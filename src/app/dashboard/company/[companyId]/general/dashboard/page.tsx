                    ...
                    <Card className='cardDashboard z-0 mt-3 w-[400px] overflow-hidden rounded-[12px]'>
                        ...
                        <div className='mt-3 overflow-hidden bg-[#8fefdc] px-4 py-2'>
                            <p className='flex items-center gap-1 font-bold text-sm'>
                                ...
                                <span className='font-light text-sm opacity-70'> 13/05/2024</span>
                            </p>
                        </div>
                    </Card>
                </div>
            </section>
            <div className='mt-7 grid gap-4 lg:grid-cols-7 md:grid-cols-2'>
                    ...
                    <CardHeader>
                        <div className='flex justify-between'>
                            ...
                            <Select>
                                ...
                                <SelectContent>
                                    <SelectItem value='Pendiente' className='rounded-none border-gray-600 border-b'>
                                        Pendiente
                                    </SelectItem>
