        ...
        <>
            ...
            <Dialog open={open} onOpenChange={setOpen}>
                <DialogContent>
                    ...
                    <Form {...form}>
                        <form onSubmit={form.handleSubmit(onSubmit)} className='flex-col items-center justify-center gap-2 space-y-8'>
                            <FormField
                                control={form.control}
                                name='expiration_date'
                                render={({ field }) => (
                                    <FormItem className='flex flex-col'>
                                        <FormLabel htmlFor='expiration_date'>Fecha de vencimiento</FormLabel>
                                        <Popover>
