            ...
            <Dialog open={open} onOpenChange={setOpen}>
                <DialogContent className='sm:max-w-[425px]'>
                    ...
                    <div>
                        ...
                        <Input id='name' placeholder='...' value={name} onChange={(e) => setName(e.target.value)} required={true} />
                    </div>
                        ...
                        <Input
                            ...
                            onChange={(e) => {
                                ...
                                try {
                                    ...
                                    setError('por favor inserte una descripcion reducida de 10 caracteres o menos')
                                }
                            }}
                        />
