        ...
        <LayoutContainer>
            ...
            <div ref={pdfRef} className='items-center justify-center p-16'>
                <div className='flex flex-row'>
                    <img src='https://utfs.io/f/761a1f9b-564b-4690-8868-e18d666b80f3-mtnazc.png' className='p-r-4' alt='logo' />
                ...
                <div className='flex flex-row justify-between'>
                    ...
                    <h4 className='font-bold'>{dayjs(confirmedAt).format('DD/MM/YYYY [a las] HH:mm:ss')}</h4>
                </div>
                <hr className='p-4' />
                <div className='flex flex-row justify-between'>
                        ...
                        {dataBatch
                            ...
                            .map((row) => (
                                <TableRow key={row.product as React.Key}>
                                    ...
                                    <TableCell>{typeof row.amount_collected === 'number' ? row.amount_collected : ''}</TableCell>
                                </TableRow>
                            ))}
                    </TableBody>
                </Table>
