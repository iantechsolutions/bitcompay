              ...
              <Tabs>
                ...
                <TabsContent value="billing">
                  ...
                  {fields.map((field, index) => (
                    <div key={field.id} className="grid gap-4 sm:grid-cols-4">
                      <FormField
                        control={form.control}
                        name={`conditional_prices.${index}.condition`}
                        render={({ field }) => (
                          <FormItem className="col-span-1">
                            <FormLabel htmlFor={`condition_${index}`}>
                              Condición
                            </FormLabel>
                            <FormControl>
                              <Input {...field} />
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem className="col-span-1">
                            <FormLabel htmlFor={`age_from_${index}`}>
                              Edad desde
                            </FormLabel>
                            <FormControl>
                              <Input {...field} />
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem className="col-span-1">
                            <FormLabel htmlFor={`age_to_${index}`}>
                              Edad hasta
                            </FormLabel>
                            <FormControl>
                              <Input {...field} />
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem className="col-span-1">
                            <FormLabel htmlFor={`price_${index}`}>
                              Precio
                            </FormLabel>
                            <FormControl>
                              <Input {...field} />
