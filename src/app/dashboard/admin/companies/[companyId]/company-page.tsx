                ...
                <Accordion type='single' collapsible={true} className='w-full'>
                    ...
                    <AccordionItem value='item-4'>
                        ...
                        <AccordionContent>
                            <List>
                                {brands?.map((brand) => {
                                    return <ListTile href={`/dashboard/admin/brands/${brand.id}`} title={brand.name} key={brand.id} />
                                })}
                            </List>
                        </AccordionContent>
                    </AccordionItem>
        ...
        <AlertDialog>
            ...
            <AlertDialogContent>
                <AlertDialogHeader>
                    ...
                    <AlertDialogDescription>Eliminar empresa permanentemente.</AlertDialogDescription>
                </AlertDialogHeader>
                <AlertDialogFooter>
