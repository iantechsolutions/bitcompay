...
export default async function Page(props: { params: { channelId: string } }) {
    ...
    const products: RouterOutputs['products']['getByChannel'] = await api.products.getByChannel.query({
        channelId: props.params.channelId,
    })
    const companies = []

    for (const product of products) {
        const companiesOfProduct: RouterOutputs['companies']['getByProduct'] = await api.companies.getByProduct.query({
