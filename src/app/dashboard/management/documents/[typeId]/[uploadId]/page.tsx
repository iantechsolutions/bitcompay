...
export default async function Page(props: {
    ...
    if (!upload) {
        return <Title>Documento no encontrado</Title>
    }
    ...
    return (
        <>
            ...
            {'confirmed' in upload && upload.confirmed && <Button className='mt-2'>Ver transacciones cargadas desde este archivo</Button>}
        </>
    )
}
