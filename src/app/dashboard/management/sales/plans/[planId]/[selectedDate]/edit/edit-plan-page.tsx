...
export default function EditPlanPage({
  ...
  // Formatear la fecha de validy_date
  const formatValidyDate = (date: any) => {
      ...
      <section className="space-y-2">
        <div className="flex justify-between">
          <div className="flex-col">
            <Title>Editar plan {planData?.description}</Title>
            <h2 className="mb-3 font-semibold text-xl">
              {planData &&
                planData.pricesPerCondition.length > 0 &&
                formatValidyDate(planData.pricesPerCondition[0]!.validy_date)}
            </h2>
          </div>
        </div>
                          ...
                          <Select
                            onValueChange={(value) => {
                              ...
                              updatedValues[index] = {
                                ...
                                validy_date:
                                  updatedValues[index]?.validy_date ??
                                  new Date(),
                                condition:
