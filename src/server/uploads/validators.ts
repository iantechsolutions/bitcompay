...
const stringAsDate = z
  ...
  .transform((value) => {
    ...
    const last4 = Number.parseInt(value.substring(4, 8));
...
export const recDocumentValidator = z
  ...
  .transform((value) => {
    ...
    return {
      ...
      product_number: Number.parseInt(value.Producto ?? "") ?? null,
...
export const recHeaders: TableHeaders = [
  ...
  // { key: "du_number", label: "Documento", width: 140 },
...
export const ComprobantesHeaders: TableHeaders = [
  ...
  { key: "fromPeriod", label: "From Period", width: 120 },
  { key: "toPeriod", label: "To Period", width: 120 },
  { key: "due_date", label: "Due Date", width: 120 },
  { key: "payedDate", label: "Payed Date", width: 120 },
  { key: "prodName", label: "Prod Name", width: 150 },
  { key: "iva", label: "IVA", width: 100 },
  { key: "billLink", label: "Bill Link", width: 120 },
  { key: "items_id", label: "Items ID", width: 120 },
