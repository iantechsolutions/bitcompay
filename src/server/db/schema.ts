...
import { bigint, boolean, index, integer, json, primaryKey, timestamp, varchar } from 'drizzle-orm/pg-core'
...
export const payment_status_relations = relations(paymentStatus, ({ many }) => ({
    payments: many(payments),
}))
