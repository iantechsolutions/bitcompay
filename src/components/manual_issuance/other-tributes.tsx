...
<div className="flex flex-col gap-5  min-w-[250px] max-w-full border rounded-lg px-4 pt-5 pb-8 bg-[#F7F7F7] ">
      <h1 className="flex flex-col gap-5 text-lg font-semibold">Otro tributos</h1>
      {fields.length === 0 && (
            ...
            value: visualizationSwitcher(
              ...
              <FormField
                ...
                render={({ field }) => (
                  <Select onValueChange={field.onChange} defaultValue={field.value}>
                    <SelectTrigger>
                      <SelectValue placeholder="Seleccionar jurisdicción" className="truncate" />
                    </SelectTrigger>
                    <SelectContent>
          ...
          element={{
            ...
            value: visualizationSwitcher(
              ...
              <FormField
                ...
                control={otherTributes.control}
                render={({ field }) => <Input type="number" className="pr-1 pb-0 border-[#bef0bb]"
                {...field} />}
              />,
              fieldElement.base
            ),
          ...
          element={{
            ...
            value: visualizationSwitcher(
              ...
              <FormField
                ...
                control={otherTributes.control}
                render={({ field }) => <Input type="number" className="w-full" {...field} />}
              />,
