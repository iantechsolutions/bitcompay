...
export default function ElementCard(props: ElementCardProps) {
  let content: React.ReactNode = (
    <div
      className={cn(
        "flex font-medium whitespace-nowrap text-[#3E3E3E] text-[0.8rem] pl-[0.9rem]",
  ...
  return (
    <div
      className={cn(
        "flex flex-col justify-stretch gap-2 p-2 pl-0 pb-1 border-b-2 text-[#747474] text-sm",
        props.className
      )}>
      <p
        className={cn(
          "flex uppercase whitespace-nowrap opacity-90 text-[0.875rem]",
          props.keyClassName
        )}>
        {props.element.key}
      </p>
