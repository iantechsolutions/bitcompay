...
const buttonVariants = cva(
  "inline-flex items-center shadow:none justify-center rounded-sm font-small text-sm transition-colors disabled:pointer-events-none disabled:opacity-50 focus-visible:outline-none focus-visible:ring-ring",
  {
    variants: {
      variant: {
        default:
        ...
        destructive:
          ...
          form:
            "border-0 shadow:none border-b text-[#3E3E3E] bg-background rounded-none hover:bg-accent hover:accent-current",
          secondary:
