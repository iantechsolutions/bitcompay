...
export function LargeEditableTable(props: {
    ...
    const handleInputChange = (rowIndex: number, key: string, newValue: string) => {
        const _row = props.rows[rowIndex]
    ...
    return (
        ...
        >
            <div className='overflow-hidden'>
                <div id={headerId} className='flex flex-nowrap overflow-hidden py-1 shadow-md'>
                    {headers.map((header) => {
            ...
            {props.reason && <div style={{ backgroundColor: 'red' }}>{props.reason}</div>}
        </tableContext.Provider>
    )
}
                ...
                return (
                    <div
                        ...
                        style={{
                            ...
                            maxWidth: w,
                            minWidth: w,
                            backgroundColor: header.key === specialCellKey ? 'red' : undefined,
                        }}
                        className='flex items-center overflow-hidden text-ellipsis whitespace-nowrap border-r px-1 last:border-none'
                    >
                        {value}
