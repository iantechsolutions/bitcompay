        ...
        <Dialog>
            ...
            <DialogContent className='h-[500px] min-w-[1200px] overflow-y-scroll'>
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Agregue un miembro aqui, especifique si es titular, responsable de pago, responsable de facturación o afiliado.
                    </DialogDescription>
                </DialogHeader>
                <Form {...form}>
                    <form onSubmit={form.handleSubmit(onSubmit)} className='mt-4 flex flex-col gap-2'>
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        ...
                                        <Input {...field} placeholder='Ingrese el apellido y nombre' />
                                    </FormItem>
                                )}
                            />
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        ...
                                        <Input {...field} placeholder='Ingrese el tipo y número de documento' />
                                    </FormItem>
                                )}
                            />
                            <FormField
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        ...
                                        <Input {...field} placeholder='Ingrese el número de domicilio' />
                                    </FormItem>
                                )}
                            />
                            <FormField
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        ...
                                        <Input {...field} placeholder='Ingrese el teléfono particular' />
                                    </FormItem>
                                )}
                            />
                            <FormField
