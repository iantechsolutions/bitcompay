...
export default function BillingInfo({ data }: propsBillingInfo) {
    ...
    const isBillingResponsible = isData && data.filter((value) => value.isBillResponsible ?? value.birth_date).length > 0
    ...
    const initialValues: InputsBilling = {
        ...
        fiscal_id_type: isBillingResponsible ? billingResponsible!.fiscal_id_type : '',
        fiscal_id_number: isBillingResponsible ? billingResponsible!.fiscal_id_number : '',
    }
    ...
    //   ));
    const onSubmit: SubmitHandler<InputsBilling> = (_data) => {}
    return (
        <Form {...form}>
                    ...
                    render={({ field }) => (
                        <FormItem>
                            ...
                            <Select onValueChange={field.onChange} defaultValue={field.value}>
                                ...
                                <SelectContent>{/* ingresa aca opciones de productos */}</SelectContent>
                            </Select>
                        </FormItem>
                    )}
                />
