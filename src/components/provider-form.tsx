...
import { CivilStatus, Gender, IdType, ProviderSchema, ProviderType, fiscalIdType } from '~/server/forms/providers-schema'
...
export default function ProviderForm({
    ...
    const initialValues: Inputs = {
        ...
        provider_code: provider?.provider_code ? provider.provider_code!.toString() : '',
        ...
        unsubscription_motive: provider?.unsubscription_motive ? provider.unsubscription_motive! : '',
    ...
    const providerTypeOptions = Object.entries(ProviderType).map(([key, value]) => (
        <SelectItem key={key} value={value}>
            {value}
        </SelectItem>
    ))
    ...
    const fiscalIdTypeOptions = Object.entries(fiscalIdType).map(([key, value]) => (
            ...
            <Form {...form}>
                ...
                >
                    ...
                    <FormField
                        ...
                        render={({ field }) => (
                            <FormItem>
                                <FormLabel htmlFor='provider_code'>Código de proveedor</FormLabel>
                                <FormControl>
                    ...
                    <FormField
                        ...
                        render={({ field }) => (
                            <FormItem>
                                <FormLabel htmlFor='id_number'>Número de identificación</FormLabel>
                                <FormControl>
                    ...
                    <FormField
                        ...
                        render={({ field }) => (
                            <FormItem>
                                <FormLabel htmlFor='fiscal_id_type'>Tipo de identificación fiscal</FormLabel>
                                <Select onValueChange={field.onChange} defaultValue={field.value}>
                                    <FormControl>
                                        <SelectTrigger>
                    ...
                    <FormField
                        ...
                        render={({ field }) => (
                            <FormItem>
                                <FormLabel htmlFor='fiscal_id_number'>Número de identificación fiscal</FormLabel>
                                <FormControl>
                    ...
                    <FormField
                        ...
                        render={({ field }) => (
                            <FormItem>
                                <FormLabel htmlFor='financial_entity'>Entidad financiera</FormLabel>
                                <FormControl>
                    ...
                    {provider && (
                        <>
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        <FormLabel htmlFor='unsubscription_motive'>Motivo de baja</FormLabel>
                                        <FormControl>
                                            <Input id='unsubscription_motive' type='text' {...field} />
                                        </FormControl>
                                        <FormMessage />
                                    </FormItem>
                                )}
                    ...
                    <Button type='submit'>{provider ? 'Actualizar Información' : 'Agregar Proveedor'}</Button>
                </form>
            </Form>
        </>
    )
